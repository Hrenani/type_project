...
void SignUP()
{
    ...
    {
        printf("your pass not the first pass\n");
        printf("enter your pass : \n");
        scanf("%s",pass);
        printf("enter your pass agane");
        scanf("%s",pass2);
    }
...
void store_score(char *name,double score,int paragraph)
{
    ...
    while(!feof(ptr))
    {
        ...
        if(strstr(word,name))
        {
            ...
            {
                if((score/10) >=1)
                sprintf(help,"name:%s\tlast_paragraph_lastscore:%d#%2.2lf\tparagraph-bestscore:%d**%02.2lf\n",name,paragraph,score,paragraph,score);
                else
                {
                    sprintf(help,"name:%s\tlast_paragraph_lastscore:%d#0%2.2lf\tparagraph-bestscore:%d**0%02.2lf\n",name,paragraph,score,paragraph,score);
                }
            }

            else
            {
                sprintf(help,"name:%s\tlast_paragraph_lastscore:%d#%02.2lf\t%s\n",name,paragraph,score,help3);
            }
    ...
    if(j == 0)
    {
        ...
        if((score/10) >= 1)
        fprintf(ptr,"name:%s\tlast_paragraph-lastscore:%d#%02.2lf\tparagraph-bestscore:%d**%02.2lf\n",name,paragraph,score,paragraph,score);
        else
        {
            fprintf(ptr,"name:%s\tlast_paragraph-lastscore:%d#0%.2lf\tparagraph-bestscore:%d**0%.2lf\n",name,paragraph,score,paragraph,score);
        }
        fclose(ptr);
    }
}
